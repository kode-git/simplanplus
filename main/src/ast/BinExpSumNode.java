...
public class BinExpSumNode implements Node, Cloneable {
    ...
    public Node typeCheck() {
        if (!(SimpLanlib.isSubtype(left.typeCheck(), new IntTypeNode()) &&
            ...
            System.out.println("Sum Error: bad operand types for binary operator '+'");
            System.exit(0);
        }
    ...
    public Node clone() {
        try {
            BinExpSumNode cloned = (BinExpSumNode) super.clone();
