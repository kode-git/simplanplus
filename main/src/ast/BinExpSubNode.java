...
public class BinExpSubNode implements Node, Cloneable {
    ...
    public Node typeCheck() {
        ...
        if (!(SimpLanlib.isSubtype(left.typeCheck(), new IntTypeNode()) &&
            ...
            System.out.println("Subtraction Error: bad operand types for binary operator '-'");
            System.exit(0);
        }
    ...
    public Node clone() {
        try {
            BinExpSubNode cloned = (BinExpSubNode) super.clone();
