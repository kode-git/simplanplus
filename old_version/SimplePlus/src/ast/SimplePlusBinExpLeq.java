...
public class SimplePlusBinExpLeq extends SimplePlusExp {
	...
	public SimplePlusBinExpLeq(SimplePlusExp left, SimplePlusExp right) {
		this.left = left;
		this.right = right;
	}
	...
	public String bytecodeGeneration(SimplePlusSymbolTable symbolTable, BytecodeLabelTable labelTable) {
		return this.right.bytecodeGeneration(symbolTable, labelTable)
				+ "PUSH\n"
