...
public class SimplePlusNegExp extends SimplePlusExp {
	...
	public SimplePlusNegExp(SimplePlusExp exp) {
		this.exp = exp;
	}
	...
	public SimplePlusTypes typeAnalysis(SimplePlusSymbolTable symbolTable, HashMap<String, SimplePlusSTVariable> scopeFunction) {
		...
		if(type != SimplePlusTypes.INT) {
			new SimplePlusError(SimplePlusErrorTypes.TYPE_MISMATCH, SimplePlusTypes.INT, type);
		}
