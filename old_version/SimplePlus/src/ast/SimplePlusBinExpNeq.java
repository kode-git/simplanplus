...
public class SimplePlusBinExpNeq extends SimplePlusExp {
	...
	public SimplePlusBinExpNeq(SimplePlusExp left, SimplePlusExp right) {
		this.left = left;
		this.right = right;
	}
	...
	public SimplePlusTypes typeAnalysis(SimplePlusSymbolTable symbolTable, HashMap<String, SimplePlusSTVariable> scopeFunction) {
		...
		if(typeLeft != typeRight) {
			new SimplePlusError(SimplePlusErrorTypes.TYPE_MISMATCH, typeLeft, typeRight);
		}
